...
def mgmt_cluster_create(admin_user, admin_password, master_ip, cluster_name='defaultCluster'):
    print "Creating cluster specification"
    auth = login('127.0.0.1', admin_user, admin_password, 'service')
    print 'Login succeded, creating cluster'
    create_cluster('127.0.0.1', master_ip, auth, cluster_name)
